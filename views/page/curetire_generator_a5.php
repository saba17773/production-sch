	...
	<table border="0" width="100%">
		<tr>
			<td align="center" valign="top">
				...
				<br>
				<br>
				<div style="font-size: 3.5em; font-weight: bold;" class="text-center"><?php echo $warehouse; ?></div>
			</td>
		</tr>
		<tr>
			<td align="center" valign="top">
				<br><br><br><br><br><br><br><br><br><br>
				<div style="font-size: <?php 	echo $font; ?>em; text-align: center; margin-top: 80px; font-weight: bold;"><?php echo $barcode; ?></div>
				<br><br><br><br><br><br><br><br><br><br>
			</td>
		</tr>
		<tr>
