...
<?php  if (isset($press1) && isset($press2) && isset($press3)){ ?>
    <table>
        <tr>
            ...
            <td colspan="17" class="f12">
                <b><i><u>SIAMTRUCK RADIAL CO.LTD.</u></i></b> <br> 
                <b><i><u>CURING REPORT</u></i></b>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
            <?php if (isset($rows12_new) && strlen($top06R)) {
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php $rows19_third=array($qty119_third,$qty219_third,$qty319_third,$qty419_third);
                if (array_sum($rows19_third)!=0) {
