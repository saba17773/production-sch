...
<h1 class="head-text">Component BODY PLY Report</h1>
<hr>
<div class="panel panel-default" style="max-width: 600px; margin: 0 auto;">
  <div class="panel-body">
    <form id="form_component" method="post" action="<?php echo root; ?>/component/report/pdf" target="_blank">
		<table align="center">
		<tr>
			<td colspan="2">
			<input type="hidden" name="mode" id="mode">
			<input type="hidden" name="report_type" id="report_type" value="13">
			</td>
		</tr>
		<tr>
			<td colspan="2">
