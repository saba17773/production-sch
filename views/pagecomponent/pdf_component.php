...
<table>
    ...
    <tr>
        ...
        <td align="center" colspan="22" class="f12">
            <h2><b><?php echo $sectionname; ?> Report</b></h2>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="2">Compound Ex 250</td>
        <td colspan="2">Compound Ex 200</td>
        <td colspan="2">Compound Ex 150</td>
        <td colspan="2">Compound Ex 90</td>
        ...
        <td rowspan="2" text-rotate="90">Scrap</td>
        <td rowspan="2" width="9%">Problem</td>
    </tr>
    <tr>
        <td>Width</td>
        <td>Length</td>
