...
<h1 class="head-text">Component Report</h1>
<hr>
<div class="panel panel-default" style="max-width: 600px; margin: 0 auto;">
  <div class="panel-body">
    <form id="form_component" method="post" action="<?php echo root; ?>/component/report/origin/pdf"
		...
		<tr>
			<td colspan="2">
				<label>วันที่</label>
				<input type="text" id="date_component" name="date_component" class=form-control required  placeholder="เลือกวันที่..." autocomplete="off" />
			</td>
		</tr>
		<tr>
			<td colspan="2">
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		getSection()
	    .done(function(data) {
	      $('select[name=section]').html("<option value=''>=Select=</option>");
