...
<head>
	<meta charset="UTF-8">
	<title>INNER LINER Report</title>
...
<table>
    ...
    <tr>
        ...
        <td align="center" colspan="18" class="f12">
            <h2><b>INNER LINER Report</b></h2>
        </td>
    </tr>
    <tr>
        <td colspan="21" class="f12" align="left">
    ...
    <tr>
        ...
        <td rowspan="2">Guage</td>
        <td rowspan="2">Weight <br> (Kg:M) </td>
        <td colspan="2">Compound-A</td>
        <td colspan="2">Compound-B</td>
        <td rowspan="2">SCH(M.) </td>
        <td colspan="3">ACT(M.)</td>
