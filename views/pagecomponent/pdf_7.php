...
<table>
    ...
    <tr>
        ...
        <td align="center" colspan="21" class="f12">
            <h2><b>SIDE WALL Report</b></h2>
        </td>
    </tr>
    <tr>
        <td colspan="24" class="f12" align="left">
    ...
    <tr>
        <td rowspan="2">No.</td>
        <td rowspan="2" width="6%">Tire Code</td>
        <td rowspan="2">Code</td>
        <td colspan="2">Width</td>
        <td rowspan="2">Weight <br> (Kg:M) </td>
        <td colspan="2">Compound Ex200</td>
        <td colspan="2">Compound Ex150</td>
        <td colspan="2">Compound Ex120</td>
        <td rowspan="2" text-rotate="90">SCH(M.)</td>
        <td colspan="3">ACT(Pcs.)</td>
        <td rowspan="2" text-rotate="90">Total Weight</td>
        <td colspan="3">เวลาที่ใช้</td>
        <td rowspan="2" text-rotate="90">Workaway</td>
        <td rowspan="2" text-rotate="90">Waste(Kg.)</td>
