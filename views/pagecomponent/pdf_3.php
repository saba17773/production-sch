...
<table>
    ...
    <tr>
        ...
        <td align="center" colspan="17" class="f12">
            <h2><b>BEAD WIRE Report</b></h2>
        </td>
    </tr>
    <tr>
        <td colspan="20" class="f12" align="left">
    ...
    <tr>
        ...
        <td rowspan="2">Circum</td>
        <td rowspan="2">Weight <br> (Kg:Pcs) </td>
        <td colspan="2">Compund</td>
        <td rowspan="2">SCH <br> (Pcs.) </td>
