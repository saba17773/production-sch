<?php $this->layout("layouts/base", ["title" => "Report Bom"]); ?>

<div class="head-space"></div>

<div class="panel panel-default" style="max-width: 500px; margin: auto;">
	<div class="panel-heading">Report Bom</div>
	<div class="panel-body">
		<form id="form_report_bom" action="/report/bom/pdf" method="post" target="_blank">
