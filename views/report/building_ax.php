<?php $this->layout("layouts/base", ["title" => "Building Ax Report"]); ?>

<div class="head-space"></div>

<div class="panel panel-default" style="max-width: 500px; margin: auto;">
	<div class="panel-heading">Building AX Report</div>
	<div class="panel-body">
		<form action="<?php echo root; ?>/report/building_ax/pdf" method="post" target="_blank">
