  ...
  <table>
    <thead>
      ...
      <tr>
        ...
        <th colspan="2" width="140px">แผนกสร้างโครง <?php echo $date2 ?></th>
        <th colspan="2" width="140px">แผนกสร้างโครง <?php echo $date3 ?></th>
        <th colspan="2" width="150px">หน้ายางขาด <?php echo $date1 ?></th>
        <th colspan="2" width="150px">หน้ายางขาด <?php echo $date2 ?></th>
        <th colspan="2" width="150px">หน้ายางขาด <?php echo $date3 ?></th>
      ...
      <tr>
        ...
        <th width="70px">
          <font size="2.2">หน้ายางขาด<BR>กะกลางคืน</font>
        </th>
        <th width="60px">
          <font size="2.2">หน้ายางขาด<BR>กะกลางวัน</font>
        </th>
