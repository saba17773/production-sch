...
<div class="panel panel-default" style="max-width: 550px; margin: auto;">
    ...
    <div class="panel-body">
        <form id="sch_submit">
            ...
            <div class="btn-group btn-group-justified" role="group">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-primary btn-lg" id="to_rowdata"><span class="glyphicon glyphicon-file"></span> Raw Data</button>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('#to_pdf').on('click', function(event) {
            ...
            $('#to_rowdata').attr("disabled", true);
            setTimeout(function() {
                $('#to_excel').attr("disabled", false);
                $('#to_rowdata').attr("disabled", false);
            }, 10000);
            $('#sch_submit').submit();
        ...
        $('#to_rowdata').on('click', function(event) {
            event.preventDefault();
            $('#open_type').val('to_rowdata');
            $('#to_pdf').attr("disabled", true);
            $('#to_excel').attr("disabled", true);
            setTimeout(function() {
                $('#to_pdf').attr("disabled", false);
        ...
        $('#sch_submit').submit(function(e) {
            ...
            if (param_date === '') {
                ...
                window.open('/production/sch/pdf/reportall/' + param_date + '/' + open_type + '/view', '_blank');
            }
        });
    });
</script>