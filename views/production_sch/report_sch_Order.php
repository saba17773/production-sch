<?php
$this->layout("layouts/base", ['title' => 'Report-Production-greentireOreder Report']);
...
<div class="panel panel-default" style="max-width: 500px; margin: auto;">
    <div class="panel-heading">รายงาน Order</div>
    ...
    jQuery(document).ready(function($) {
        ...
        $('#sch_curing').submit(function(e) {
            ...
            if (param_date === '') {
                ...
                window.open('/production/sch/pdf/report/greentire/order_report/' + param_date + '/' + param_shift + '/' + param_checktype + '/view', '_blank');
            }
