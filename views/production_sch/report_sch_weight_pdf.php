	...
	<table>
		<tr>
			...
			<td colspan="140" class="td">
				<h2>
					สรุป น้ำหนักผลิต อบยางนอกรถยนต์ประจำ  เดือน  <?php echo $monththai." พ.ศ.".$yearthai; ?>
				</h2>
			</td>
		</tr>
		...
		<tr style="background-color: #35ABAF; color: white;"> 
			...
			<th rowspan="2" width="250px;">SIZE</th> 
			<th rowspan="2" width="50px;">PR</th> 
			<th rowspan="2" width="50px;">CODE</th> 
			<th rowspan="2" width="80px;">PATTERN</th> 
			<th rowspan="2" width="40px;">TT</th> 
			<th rowspan="2" width="120px;">COLOR</th> 
			...
			?>
			<th colspan="4" width="200px;"><?php echo $i; ?></th> 
			<?php } ?>

			<th colspan="5" width="250px;">รวม</th> 
		...
		<tr style="background-color: #13A19C; color: white;" valign="top"> 
			<?php  
				for ($i=1; $i <= $nummonth; $i++) { 
			?>
			<th width="50px;">ผลิตได้กะ C</th> 
			<th width="50px;">ผลิตได้กะ D</th> 
			<th width="50px;">น้ำหนักเป้า</th>
			<th width="50px;">น้ำหนักผลิตได้</th>
			<?php } ?>

			<th width="50px;" style="background-color: #F7E565; color: black;">ผลิตได้กะ C</th> 
			<th width="50px;" style="background-color: #F7E565; color: black;">ผลิตได้กะ D</th> 
			<th width="50px;" style="background-color: #F26936; color: black;">น้ำหนักเป้า</th>
			<th width="50px;" style="background-color: #F26936; color: black;">น้ำหนักผลิตได้</th>
			<th width="50px;" style="background-color: #F7E565; color: black;">รวมผลิตได้</th>
		</tr> 
		...
		<tr style="background-color: #F7FFD8;">
			...
			?>
				...
				<td><?php echo ($l['NetWeight']*($l['ActualC']+$l['ActualD'])); ?></td>
				<td><?php echo ($l['Weight']*($l['ActualC']+$l['ActualD'])); ?></td>
			<?php 

				$sumactualc += $l['ActualC'];
				$sumactuald += $l['ActualD'];
				$sumnetweight += ($l['NetWeight']*($l['ActualC']+$l['ActualD']));
				$sumweight += ($l['Weight']*($l['ActualC']+$l['ActualD']));
			...
			<td><?php echo $sumnetweight; $sumnetweight_all += $sumnetweight; ?></td>
			<td><?php echo $sumweight; $sumweight_all += $sumweight; ?></td>
		...
		<tr style="background-color: #35ABAF; color: white;">
			...
			<?php 
				for ($i=0; $i < $nummonth; $i++) { 
					...
					echo "<th>".$arr_sum['NW'][$i]."</th>";
					echo "<th>".$arr_sum['W'][$i]."</th>";
				}
			?>
			...
			<th style="background-color: #F26936; color: black;"><?php echo $sumnetweight_all; ?></th>
			<th style="background-color: #F26936; color: black;"><?php echo $sumweight_all; ?></th>
