...
header("Content-Disposition: attachment; filename=ProductionSch_WeightReport".Date("Ymd_His").".xls");
?>
<!DOCTYPE html>
<html>
<style type="text/css">
		...
		<tr>
			<td colspan="2">
				...
				<?php if ($_SESSION['user_company']=='DSL'){ ?>
					<img  src="/assets/images/DSL.png" style="padding-left:10px;height:25px; width:120px;" />
				<?php } ?>
