...
<body>
    ...
    <thead>
		...
		<tr>
			...
			<td width="5%"><font size="2.2">Stock<BR>ในแผนก(เส้น)</font></td>
			<td width="7%"><font size="2.2">คงเหลือ หน้าเตา+<BR>แผนกกรีนไทร์<BR> (เส้น)</font></td>

        <td width="5%" ><font size="2.2"><?php echo $shiftcheck ;?></font></td>
        <td width="5%"> <font size="2.2"><?php echo $shiftcheck2 ; ?></font></td>
