...
<div class="panel panel-default" style="max-width: 500px; margin: auto;">
	<div class="panel-heading">รายงาน Stock แผนสั่งออกหน้ายาง</div>
		...
		<form id="sch_curing">
			...
			<div class="form-group">
				...
				<select name="sch_shift" id="sch_shift" class="form-control" required>
					...
					<option value="3">All 08.00-20.00</option>
					<option value="4">All 20.00-08.00</option>
				</select>
			</div>
	...
	jQuery(document).ready(function($) {
		...
		$('#sch_curing').submit(function(e) {
			...
			if (param_date === '') {
				...
				window.open('/production/sch/pdf/report/greentire/plantire_report/' + param_date + '/' + param_shift + '/' + param_checktype + '/view', '_blank');
			}
