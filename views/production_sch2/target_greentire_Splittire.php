...
<div class="panel panel-default" style="max-width: 500px; margin: auto;">
	<div class="panel-heading">รายงาน แยกชนิดยาง</div>
	...
	jQuery(document).ready(function($) {
        ...
        $('#sch_curing').submit(function(e) {
			...
			if (param_date === '' ) {
				...
				window.open('/production/sch/pdf/report/greentire/splittire_report/' + param_date + '/' + param_shift +'/' + param_checktype + '/view', '_blank');
			}
